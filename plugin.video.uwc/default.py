...
#    utils.addDir('[COLOR hotpink]XVideosHits - NETU !!![/COLOR]','https://www.xvideoshits.com/',700,os.path.join(imgDir, 'xvideoshits.png'),'')
    ...
    utils.addDir('[COLOR hotpink]Eporner[/COLOR]','https://www.eporner.com/category/gay/',540,'https://static-eu-cdn.eporner.com/new/logo.png','')
  utils.addDir('[COLOR hotpink]Boyfriendtv[/COLOR]', 'https://www.boyfriendtv.com/category/all/', 540, 'https://static-eu-cdn.boyfriendtv.com/new/logo.png', '')')
